...
public class BlockDecorative extends Block{
	...
	public static String[] subBlocks = new String[] {"BrickCastle"};
	...
	public void registerBlockIcons(IIconRegister par1IconRegister){	
		...
		for(int i = 0; i < subBlocks.length; i++){
			this.iconArray[i] = par1IconRegister.registerIcon(References.RESOURCESPREFIX + BlockStrings.DECORATIVEBLOCK_NAME + subBlocks[i]);
		}
	}
