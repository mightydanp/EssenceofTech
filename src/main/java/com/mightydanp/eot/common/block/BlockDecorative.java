...
public class BlockDecorative extends Block{
	...
	public static String[] subBlocks = new String[] {"brick_castle"};
	...
	public void registerBlockIcons(IIconRegister par1IconRegister){	
		...
		for(int i = 0; i < subBlocks.length; i++){
			this.iconArray[i] = par1IconRegister.registerIcon(References.RESOURCES_PREFIX + BlockReferences.DECORATIVE_BLOCK_NAME + "_" + subBlocks[i]);
		}
	}
