...
public class ItemRawPowder extends Item {
	...
	protected ItemRawPowder(String unlocalizedName) {
	...
	public void registerIcons(IIconRegister reg) {
	    for (int i = 0; i < subItems.length; i ++) {
	        this.iconArray[i] = reg.registerIcon(References.RESOURCES_PREFIX + ItemReferences.RAW_POWDER_NAME + "_" + subItems[i]);
	    }
	}
