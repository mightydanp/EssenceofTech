...
public class ItemPowder extends Item {
	...
	public static String[] subItems = new String[] {"iron", "gold", "copper", "tin", "silver", "lead", "bronze"};
	
	protected ItemPowder(String unlocalizedName) {
	...
	public void registerIcons(IIconRegister reg) {
	    for (int i = 0; i < subItems.length; i ++) {
	        this.iconArray[i] = reg.registerIcon(References.RESOURCES_PREFIX + ItemReferences.POWDER_NAME + "_" + subItems[i]);
	    }
	}
