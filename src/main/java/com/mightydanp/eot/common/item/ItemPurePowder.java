...
public class ItemPurePowder extends Item {

    public IIcon[] iconArray = new IIcon[subItems.length];
	
	public static String[] subItems = new String[] {"iron", "gold", "copper", "tin", "silver", "lead"};
	
	protected ItemPurePowder(String unlocalizedName) {
	...
	public void registerIcons(IIconRegister reg) {
	    for (int i = 0; i < subItems.length; i ++) {
	        this.iconArray[i] = reg.registerIcon(References.RESOURCES_PREFIX + ItemReferences.PURE_POWDER_NAME + "_" + subItems[i]);
	    }
	}
