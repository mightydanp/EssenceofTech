...
public class WorldGenMinableCore extends WorldGenerator
{
    ...
    public WorldGenMinableCore(IBlockState state, int blockCount, Block block)
    {
        this(state, blockCount, BlockMatcher.forBlock(block));
    }

    public WorldGenMinableCore(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
